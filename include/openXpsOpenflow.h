 ...
 */
  ...
  * \return XP_STATUS
  */
 XP_STATUS xpsOfRegisterFlowStatsFlushHandler(xpOfFlowStatsFlushHandler func, void *userData);
  ...
  * \return XP_STATUS
  */
 XP_STATUS xpsOfGetOfppLocalIntfId(xpsDevice_t devId, xpDatapath_t dpId, xpsInterfaceId_t *intfId);
  ...
  * \return XP_STATUS
  */
 XP_STATUS xpsOfGetOfppControllerIntfId(xpsDevice_t devId, xpDatapath_t dpId, xpsInterfaceId_t *intfId);
 ...
 XP_STATUS xpsOfAddGroup(xpsDevice_t devId, xpDatapath_t dpId,
                         uint32_t groupId, xpOfGroupType_e groupType, xpOfBucket_t* buckets, uint32_t bucketsNum);
